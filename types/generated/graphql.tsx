...
export type GetUserByIdsQueryVariables = Exact<{
  id: Scalars['uuid'];
}>;


export type GetUserByIdsQuery = { __typename?: 'query_root', users_by_pk?: { __typename?: 'users', id: any, name: string, created_at: any } | null };
...
export const GetUserByIdsDocument = gql`
    query GetUserByIds($id: uuid!) {
  users_by_pk(id: $id) {
    id
    name
    created_at
...
/**
 * __useGetUserByIdsQuery__
 *
 * To run a query within a React component, call `useGetUserByIdsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUserByIdsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUserByIdsQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetUserByIdsQuery(baseOptions: Apollo.QueryHookOptions<GetUserByIdsQuery, GetUserByIdsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserByIdsQuery, GetUserByIdsQueryVariables>(GetUserByIdsDocument, options);
      }
export function useGetUserByIdsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserByIdsQuery, GetUserByIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserByIdsQuery, GetUserByIdsQueryVariables>(GetUserByIdsDocument, options);
        }
export type GetUserByIdsQueryHookResult = ReturnType<typeof useGetUserByIdsQuery>;
export type GetUserByIdsLazyQueryHookResult = ReturnType<typeof useGetUserByIdsLazyQuery>;
export type GetUserByIdsQueryResult = Apollo.QueryResult<GetUserByIdsQuery, GetUserByIdsQueryVariables>;
